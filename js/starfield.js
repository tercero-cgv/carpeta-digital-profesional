// ============================================================
// STARFIELD — Fondo animado ambiental
// ============================================================
(function () {
  ...
  function maybeSpawnShootingStar() {
    ...
    if (Math.random() < 0.002 && shootingStars.length < 2) {
      ...
      shootingStars.push({ x: startX, y: startY, len: Math.random() * 80 + 60, speed: Math.random() * 6 + 8, angle: Math.PI / 5, life: 1 });
    }
  }
  ...
  function draw() {
    ...
    for (const s of stars) {
      const twinkle = prefersReducedMotion ? 0 : Math.sin(t * s.twinkleSpeed + s.twinklePhase) * 0.25;
    ...
    shootingStars.forEach((star) => {
      ...
      const grad = ctx.createLinearGradient(star.x, star.y, star.x - dx, star.y - dy);
